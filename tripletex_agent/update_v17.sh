...
echo "=== v17: deploy bundle (prompt_parser + orchestrator) ==="
...
def parse_prompt(prompt, extra_text=None):
    ...
    if entity in ("ledger_closing", "bank_reconciliation"):
        return {
...
"""Orchestrator v17 - existing invoice payment, ledger/bank unsupported routing.
