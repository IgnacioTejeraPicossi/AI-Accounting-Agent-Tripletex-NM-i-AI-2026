...
echo "=== v4: Multi-entity support (create ALL departments/products/customers/employees) ==="
...
"""Orchestrator v4 - multi-entity support.

Key changes from v2/v3:
- All handlers support entities["items"] list for batch creation
- Parser now extracts ALL quoted names when multiple are present
"""
import json
import sys
import time
...
# --- Deploy ---
echo "=== Deploying v4 to Cloud Run ==="
cd ~/tripletex_agent
